...
class ex04
{
    public void Run()
    {
        ...
        StreamWriter sw = new StreamWriter("ex04.txt", false, Encoding.ASCII); 
        ...
        StreamReader sr = new StreamReader("ex04.txt");
        ...
        while (line != null) //While para parar quando line ser null
        {
            ...
            Console.WriteLine("A linha escrito: "+line+ " tem "+cont+" caracteres (a)"); //Resultado
